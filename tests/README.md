...
- `test_phase36_in_memory_web_jobs.py` exact 5 MB default, content/extension matching, upload preview and sample-thumbnail contracts, memory-only provenance, asynchronous progress events, successful terminal reports, and rejection before queueing
